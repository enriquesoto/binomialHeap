...
void BinomialHeap::decreaseKey(BinomialHeap &b, int oldValue, int newKey)
{
    NodoB *y;
    NodoB *z;
    NodoB *foundNode;
...
NodoB *BinomialHeap::find(NodoB &b,int value)
{
    if(b.key==value)
        return &b;
    NodoB *x = &b;
...
NodoB *BinomialHeap::bfs(NodoB &b,int value)
{
...
BinomialHeap *BinomialHeap::deleteNode(BinomialHeap &bh, int target)
{
